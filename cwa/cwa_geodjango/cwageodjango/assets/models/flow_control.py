...
from cwageodjango.assets.constants import FLOW_CONTROL__NAME
...
class FlowControl(models.Model):
    ...
    dmas = models.ManyToManyField(DMA, related_name="dma_flow_controls")
