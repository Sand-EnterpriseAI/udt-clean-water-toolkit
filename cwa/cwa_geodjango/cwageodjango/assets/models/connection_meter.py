...
from cwageodjango.core.constants import DEFAULT_SRID, CONNECTION_METER__NAME


class ConnectionMeter(models.Model):
    ...
    dmas = models.ManyToManyField(DMA, related_name="dma_connection_meters")
    ...
    class AssetMeta:
        asset_name = CONNECTION_METER__NAME
